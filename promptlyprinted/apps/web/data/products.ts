...
export const tshirtDetails = {
  ...
  'A-MH-JH001': {
    ...
    colorOptions: [
      ...
      { name: 'Royal Blue', filename: 'royal-blue.png' },
      { name: 'Sky Blue', filename: 'sky-blue.png' },
      { name: 'Varsity Green', filename: 'varsity-green.png' },
      { name: 'White', filename: 'white.png' },
  ...
  'A-WH-JH001F': {
    ...
    colorOptions: [
      { name: 'Airforce Blue', filename: 'airforce-blue.png' },
      { name: 'Black', filename: 'black.png' },
      { name: 'Burgundy', filename: 'burgundy.png' },
      { name: 'Candy Pink', filename: 'candy-pink.png' },
      { name: 'Fire Red', filename: 'fire-red.png' },
      { name: 'French Navy', filename: 'french-navy.png' },
      { name: 'Hawaiian Blue', filename: 'hawaiian-blue.png' },
      { name: 'Heather Grey', filename: 'heather-grey.png' },
      { name: 'Hot Pink', filename: 'hot-pink.png' },
      { name: 'Jade', filename: 'jade.png' },
      { name: 'Lime Green', filename: 'lime-green.png' },
      { name: 'New French Navy', filename: 'new-french-navy.png' },
      { name: 'Orange Crush', filename: 'orange-crush.png' },
      { name: 'Plum', filename: 'plum.png' },
      { name: 'Red Hot Chilli', filename: 'red-hot-chilli.png' },
      { name: 'Royal Blue', filename: 'royal-blue.png' },
      { name: 'Sage', filename: 'sage.png' },
      { name: 'Sapphire Blue', filename: 'sapphire-blue.png' },
      { name: 'Stargazer', filename: 'stargazer.png' },
      { name: 'Sunset Orange', filename: 'sunset-orange.png' },
      { name: 'Tangerine', filename: 'tangerine.png' },
      { name: 'Varsity Green', filename: 'varsity-green.png' },
      { name: 'White', filename: 'white.png' },
      { name: 'Yellow', filename: 'yellow.png' },
    ],
