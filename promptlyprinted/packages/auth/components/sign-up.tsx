...
export const SignUp = () => {
  ...
  const hasSocialAuth = hasGoogleAuth || hasAppleAuth || hasGithubAuth;
    ...
    <div className="w-full max-w-md mx-auto space-y-6">
        ...
        <div className="space-y-3">
          {hasGoogleAuth && (
            <button
              ...
              disabled={loading}
              className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 flex items-center justify-center gap-2"
            >
      ...
      <div className="text-center">
        <p className="text-sm text-gray-600">
          ...
          <Link href="/sign-in" className="font-medium text-[#16C1A8] hover:text-[#0D2C45]">
            Sign in
          </Link>
        </p>
      </div>
