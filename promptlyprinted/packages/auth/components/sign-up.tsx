        ...
        <div className="space-y-3">
          {hasGoogleAuth && (
            <button
              ...
              disabled={loading}
              className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#16C1A8] disabled:opacity-50 flex items-center justify-center gap-2"
            >
