...
function convertFromUSD(amount: number, targetCurrency: keyof typeof exchangeRates): number {
...
function generatePricingArray(basePrice: number): Array<{ amount: number; currency: string }> {
  return [
