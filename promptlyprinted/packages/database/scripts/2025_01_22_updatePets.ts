  ...
  'Pet Beds': [
    {
      ...
      price: '49.99',
      name: 'Pet Bed Small',
      description: 'Cozy bed for small pets with custom printed design.',
    },
    {
      sku: 'H-PET-MEDIUM-PB',
      price: '69.99',
      name: 'Pet Bed Medium',
      description:
        'Comfortable bed for medium pets with custom printed design.',
    },
    {
      sku: 'H-PET-LARGE-PB',
      price: '79.99',
      name: 'Pet Bed Large',
      description: 'Spacious bed for large pets with custom printed design.',
    },
  ],
  'Pet Accessories': [
    {
      ...
      description: 'Stylish bandana for small pets, adjustable fit.',
    },
    {
      sku: 'PET-BANDANA-MED',
      price: '23.99',
      name: 'Pet Bandana Medium',
      description: 'Stylish bandana for medium pets, adjustable fit.',
    },
    {
      sku: 'PET-BANDANA-LRG',
      price: '24.99',
      name: 'Pet Bandana Large',
      description: 'Stylish bandana for large pets, adjustable fit.',
    },
    {
      sku: 'PET-MET-BONE',
      price: '13.99',
      name: 'Pet Tag - Bone',
      description: 'Custom pet ID tag in bone shape.',
    },
    {
      sku: 'PET-MET-ROUND',
      price: '13.99',
      name: 'Pet Tag - Round',
      description: 'Custom pet ID tag in round shape.',
    },
  ],
};
