  ...
  'Small Tattoos': [
    {
      sku: 'GLOBAL-TATT-S',
      price: '9.99',
      name: '2x3-inch Temporary Tattoo',
      description:
        'Small round temporary tattoo, perfect for simple designs and symbols.',
    },
  ],
  'Medium Tattoos': [
    {
      sku: 'GLOBAL-TATT-M',
      price: '16.99',
      name: '3x4-inch Temporary Tattoo',
      description: 'Medium temporary tattoo for detailed artwork.',
    },
  ],
};
